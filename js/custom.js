...
var paragraphText = '<p>Taken by Fox <br><br> "Life is not all about pain and regret, but about the experiences and learnings, we have. The best thing about Life is that it keeps moving forward. No matter what happens in our lives at one point, our life keeps moving and so we should also learn to move on in our life without any regrets." </p>';

//Type text Section 1
const typedTextSpan = document.querySelector(".typed-text");
const cursorSpan = document.querySelector(".cursor");

const textArray = ["- 私の世界へようこそ", "- 내 세계에 오신 것을 환영합니다", "- Добро пожаловать в мой мир", "- willkommen in meiner Welt"];
